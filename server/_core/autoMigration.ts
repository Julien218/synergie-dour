...
const CREATE_TABLES = [
  ...
  `CREATE TABLE IF NOT EXISTS merchant_seo (
  id INT AUTO_INCREMENT PRIMARY KEY,
  ...
  jsonld_type VARCHAR(100) DEFAULT 'LocalBusiness',
  jsonld_extra TEXT,
  visual_1080x1080_url TEXT,
  visual_1080x1920_url TEXT,
  visual_1200x630_url TEXT,
  visual_1280x720_url TEXT,
  seo_status ENUM('draft','validated','published') NOT NULL DEFAULT 'draft',
  visual_status ENUM('draft','pending_validation','validated') NOT NULL DEFAULT 'draft',
  validated_by INT NULL,
  validated_at TIMESTAMP NULL,
  createdAt TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  updatedAt TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  FOREIGN KEY (merchant_id) REFERENCES merchants(id) ON DELETE CASCADE,
  INDEX idx_ms_merchant (merchant_id),
  INDEX idx_ms_slug (seo_slug(100))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci`,
  `CREATE TABLE IF NOT EXISTS merchant_visuals (
  id INT AUTO_INCREMENT PRIMARY KEY,
  merchant_id INT NOT NULL,
  format ENUM('1080x1080','1080x1920','1200x630','1280x720') NOT NULL,
  template_type ENUM('evenement','nouveau_membre','mise_en_avant','local_commercial','institutionnel') NOT NULL DEFAULT 'mise_en_avant',
  image_url TEXT NOT NULL,
  prompt_used TEXT,
  logos_applied TINYINT(1) NOT NULL DEFAULT 0,
  logos_count INT NOT NULL DEFAULT 0,
  status ENUM('draft','pending_validation','validated','rejected') NOT NULL DEFAULT 'pending_validation',
  validation_note TEXT,
  validated_by INT NULL,
  validated_at TIMESTAMP NULL,
  generated_by INT NULL,
  createdAt TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  INDEX idx_mv_merchant (merchant_id),
